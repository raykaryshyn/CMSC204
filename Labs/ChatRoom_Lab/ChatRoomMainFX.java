...
public class ChatRoomMainFX extends BorderPane {
	...
	/**
	 * The MainPanel constructor sets up the entire GUI in this template. This
	 * application assumes that the server and clients will be run on the same
	 * computer.
	 */
	ChatRoomMainFX() {
		...
		centerPane.getChildren().addAll(titleLabel, instructionsLabel1, instructionsLabel2, instructionsLabel3,
				instructionsLabel4, instructionsLabel5);
		...
		startClientButton
				.setTooltip(new Tooltip("Select this to start a Chat Room client. Can be selected multiple times."));
