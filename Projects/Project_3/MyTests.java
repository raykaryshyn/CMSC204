...
public class MyTests {
    ...
    public void testRemove() {
        String a1 = "ray", a2 = "ray", a3 = "ray", a4 = "cassy", a5 = "cassy";
        BasicDoubleLinkedList<String> linkedString1 = new BasicDoubleLinkedList<String>();
        linkedString1.addToFront(a1);
        System.out.println(linkedString1.toArrayList());
        linkedString1.addToFront(a2);
        System.out.println(linkedString1.toArrayList());
        linkedString1.addToFront(a3);
        System.out.println(linkedString1.toArrayList());
        linkedString1.addToFront(a4);
        System.out.println(linkedString1.toArrayList());
        linkedString1.addToEnd(a5);
        System.out.println(linkedString1.toArrayList());
        assertEquals(a4, linkedString1.getFirst());
        assertEquals(a5, linkedString1.getLast());
        linkedString1.remove(a4, comparator);
        System.out.println(linkedString1.toArrayList());
        linkedString1.remove(a5, comparator);
        System.out.println(linkedString1.toArrayList());
    }
